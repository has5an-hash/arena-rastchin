...
5. پوشه همان محصول در `10-PRODUCTS/`
...
- لورانیک ادمین: `10-PRODUCTS/LORANIQ-ADMIN/`
- آقای سئو: `10-PRODUCTS/MR-SEO/`

## هدف Arena
Arena می‌تواند محصول جدید بسازد یا محصولات موجود را ادامه دهد، اما باید وضعیت واقعی فایل‌ها و منابع همین مخزن را مبنا بگیرد. برای محصول جدید از ساختار و Gateهای پروژه استفاده کن؛ از ادعا یا قابلیت ساختگی برای سریع‌ترشدن انتشار استفاده نکن.
