...
while(have_posts()) { the_post();
    ...
    $profiles=array(
        'nails'=>array('order'=>'services,comparison,signature,portfolio,about,availability,testimonials,team,blog,faq','services'=>6,'portfolio'=>6,'team'=>3,'blog'=>3,'about'=>'ظرافت، از انتخاب رنگ تا آخرین جزئیات.','years'=>'8'),
    ...
    foreach(array_filter(array_map('sanitize_key',explode(',',$order))) as $section){
