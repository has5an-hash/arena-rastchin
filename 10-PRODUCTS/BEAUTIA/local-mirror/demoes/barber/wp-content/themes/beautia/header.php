...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header<?php echo get_theme_mod( 'beautia_sticky_header', true ) ? ' is-sticky' : ''; ?>">
		...
		<div class="header-search" id="beautia-search">
			<div class="container smart-search" role="search"><button class="search-close" type="button" aria-label="بستن جستجو"><?php beautia_icon( 'close', 20 ); ?></button><label class="screen-reader-text" for="beautia-live-search">جستجوی هوشمند خدمات و محتوا</label><div class="smart-search-field"><span aria-hidden="true"><?php beautia_icon( 'search', 21 ); ?></span><input id="beautia-live-search" class="search-field" type="search" autocomplete="off" placeholder="نام خدمت، مقاله یا نمونه‌کار را بنویسید…"><kbd>ESC</kbd></div><div class="search-suggestions" id="beautia-search-suggestions" aria-live="polite"><p>برای نمونه «کوتاهی»، «فیشیال» یا «مژه» را جستجو کنید.</p></div></div>
		</div>
	</header>
